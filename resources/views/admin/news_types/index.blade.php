...
@section('main')
<div class="container">
    <a class="btn btn-success mb-3" href="/admin/news_type/create">新增類別</a>
    <table id="myTable" class="display">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{$item->en_name}}</td>
                <td>
                    <a class="btn btn-success" href="/admin/news_type/edit/{{$item->id}}">編輯</a>
