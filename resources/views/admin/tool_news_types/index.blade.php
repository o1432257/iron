...
@section('main')
<div class="container">
    <a class="btn btn-success mb-3" href="/admin/toolnews_type/create">新增工具類別</a>
    <table id="myTable" class="display">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{$item->en_name}}</td>
                <td>
                    <a class="btn btn-success" href="/admin/toolnews_type/edit/{{$item->id}}">編輯</a>
...
<script>
    ...
    function delete_news(id) {
        ...
        //送出表單
        fetch('/admin/toolnews_type/delete/',{
        method:'POST',
        body:formData,
        }).then((response)=> {
            //刪除畫面上的舊資料...你自己來
