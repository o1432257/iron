...
@section('main')
    ...
    <section class="banner">
        <div class="pic" style="background-image: url('{{ asset('images/列表-左.jpg') }}');">
            @if (Session::get('local') == 'zhtw')
                <a href="/zhtw/ironman" class="banner_mask">
                @else
                    <a href="/en/ironman" class="banner_mask">
            @endif
            <button class="yellow_border meet">鋼鐵人</button>
            </a>
        </div>
        <div class="pic_man" style="background-image: url('{{ asset('images/列表-右.jpg') }}');">
    ...
    <section class="content">
        ...
        <div class="all_cards">
            <div id="cardBox" class="mycontainer ">
                @if (Session::get('local') == 'zhtw')
                    @foreach ($news as $new)
                        <div class="card " data-aos="zoom-in" style="transition: 0.25s;">
                            <div class="pic">
                                <img src="{{ $new->img }}" alt="">
                                <div class="card_classification">{{ $new->toolNewsType->name }}</div>
                            </div>
                ...
                @else
                    @foreach ($news as $new)
                        <div class="card " data-aos="zoom-in" style="transition: 0.25s;">
                            <div class="pic">
                                <img src="{{ $new->img }}" alt="">
                                <div class="card_classification">{{ $new->toolNewsType->en_name }}</div>
                            </div>
                            <div class="card_container">
                                <div class="day">
                                    <span class="date">{{ $new->date }}</span>
            ...
            <div id="cardMore" class="btn_more " data-aos="zoom-in" style="transition: 0.25s;">
                    ...
                    function(data) {
                        cardBox.innerHTML += `
                                                                        ...
                                                                        <div class="pic">
                                                                            ...
                                                                            <div class="card_classification">${ data.tool_news_type.name }</div>
                                                                        </div>
                                                                        <div class="card_container">
                                                                            <div class="day">
                                                                            ...
                                                                            <a href="/zhtw/tool/${ data.id }"><div class="title">${ data.title }</div></a>
                                                                            <div class="card_content">${ data.preview }</div>
                                                                            <a href="/zhtw/tool/${ data.id }"><div class="more">繼續閱讀</div></a>
                                                                        </div>
                                                                    </div>`
                    }
                )
                    ...
                    function(data) {
                        cardBox.innerHTML +=
                            `
                                                                        ...
                                                                        <div class="pic">
                                                                            <img src="${ data.img }" alt="">
                                                                            <div class="card_classification">${ data.tool_news_type.en_name }</div>
                                                                        </div>
                                                                        <div class="card_container">
                                                                            <div class="day">
                                                                                <span class="date">${ data.date }</span>
                                                                            ...
                                                                            <a href="/en/tool/${ data.id }"><div class="title">${ data.en_title }</div></a>
                                                                            <div class="card_content">${ data.en_preview }</div>
                                                                            <a href="/en/tool/${ data.id }"><div class="more">繼續閱讀</div></a>
                                                                        </div>
                                                                    </div>`
                    }
                )
